...
#define MY_UUID { 0xCA, 0x1E, 0xE8, 0x77, 0x2C, 0xD9, 0x43, 0x1E, 0x90, 0xFD, 0xCA, 0x0F, 0xF8, 0x59, 0xBD, 0x88 }
PBL_APP_INFO(MY_UUID,
	     "Rorschach Black", "ZissCo",
...
void handle_init(AppContextRef ctx) {
  ...
  window_init(&window, "Rorschach Black");
